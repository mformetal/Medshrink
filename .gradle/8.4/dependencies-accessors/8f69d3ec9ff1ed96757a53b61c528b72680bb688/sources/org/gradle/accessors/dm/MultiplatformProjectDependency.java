...
public class MultiplatformProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":multiplatform:di"
     */
    public Multiplatform_DiProjectDependency getDi() { return new Multiplatform_DiProjectDependency(getFactory(), create(":multiplatform:di")); }
